 ...
 * 长方形
 */
public class ChangFangView extends PicChildView {
    ...
    public ChangFangView(Context context) {
        this(context, null);
    }

    public ChangFangView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ChangFangView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
