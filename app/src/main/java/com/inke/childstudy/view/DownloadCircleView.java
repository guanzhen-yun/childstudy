package com.inke.childstudy.view;
...
import com.inke.childstudy.App;
import com.inke.childstudy.utils.DensityUtils;
...
public class DownloadCircleView extends View {
  ...
  Paint mTxtPaint;
  int outsideRadius = DensityUtils.dp2px(App.getApp(), 100);
  int progressWidth = DensityUtils.dp2px(App.getApp(), 2);
  float progressTextSize = DensityUtils.dp2px(App.getApp(), 12);
  Context context;
  ...
  protected void onDraw(Canvas canvas) {
    ...
    canvas.drawText(txt, (float) x1 - strwid / 2,
        (float) y1 + progressTextSize / 2 - progressWidth / 2, mTxtPaint);
