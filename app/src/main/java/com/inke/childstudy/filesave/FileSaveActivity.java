...
public class FileSaveActivity extends BaseActivity {
  ...
  public void downloadApk(final Activity context, String down_url) {
    ...
    DownloadUtils.getInstance()
        .download(down_url, FileUtils.getInstance().getDownloadPath(), "childstudy.apk",
            new DownloadUtils.OnDownloadListener() {
              @Override
              public void onDownloadSuccess() {
                dialogProgress.dismiss();
                LogUtils.i("恭喜你下载成功，开始安装！==" + FileUtils.getInstance().getDownloadPath()
                    + "childstudy.apk");
                ToastUtils.showToast("恭喜你下载成功，开始安装！");
                String successDownloadApkPath =
                    FileUtils.getInstance().getDownloadPath() + "childstudy.apk";
    ...
    public void onClick(View arg0) {
      Thread thread = new Thread() {
        ...
        public void run() {
          ...
          httpDownLoader.downfile(
              "https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fm2.biz.itc.cn%2Fpic%2Fnew%2Fn%2F57%2F19%2FImg7121957_n.jpg&refer=http%3A%2F%2Fm2.biz.itc.cn&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=jpeg?sec=1634115200&t=a2bc232ceb61777879de9cfb2f3a07f6",
              "goodimg/", "girl.jpg");
        }
      };
      thread.start();
